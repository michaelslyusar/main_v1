...
// *** Changes made ***
// Clean axios request and implement the request right in the onSubmit function
// Fix the redirect of the login button
// Adding catch to the axios requestin case of failed attempt
